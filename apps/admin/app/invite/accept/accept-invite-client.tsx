...
export default function AcceptInviteClient({ token, invite }: { token: string; invite: InviteInfo }) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-neutral-200 p-8 max-w-sm w-full">
      ...
      <div className="mb-6">
        <label htmlFor="name" className="block text-xs font-semibold text-neutral-500 mb-1">
          Your name (optional)
        </label>
        <input
          id="name"
          ...
          className="w-full border border-neutral-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500"
        />
      </div>
