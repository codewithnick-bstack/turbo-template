...
- [x] **Unit 5.2: White-label branding**
...
- [x] **Unit 5.3: Template marketplace v1 (first-party)**
...
- [x] **Unit 5.4: Reseller billing (Stripe Connect)**
...
- [x] **Unit 5.6: Accessibility baseline (WCAG 2.2 AA)**
...
- [x] **Unit 5.7: `packages/ui` design system + Storybook + Chromatic**
...
- [x] **Unit 5.8: Performance pass (CWV ≥ Good at p75)**
