...
- [ ] **Unit 6.1: `apps/docs` (Nextra) with generated reference**
...
- [ ] **Unit 6.2: CLI (`packages/cli` → published `@repo/cli`)**
...
- [ ] **Unit 6.4: Compliance — SOC 2 + GDPR/CCPA tooling**
...
- [ ] **Unit 6.6: Developer platform — OAuth apps + scoped tokens + partner directory**
...
- [ ] **Unit 6.7: GTM — pricing page + status page + support**
